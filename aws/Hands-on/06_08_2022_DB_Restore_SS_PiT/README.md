...
- This time we are going to connect as `admin` using the password defined `C` to the newly RDS Instance named `restored-from-man-snapshot` that is created from snapshot.
